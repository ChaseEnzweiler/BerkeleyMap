...
public class MapServer {
    ...
    private static final String IMG_ROOT = "../library-sp18/library-sp18/data/proj3_imgs/";
    /**
     * The OSM XML file path. Downloaded from <a href="http://download.bbbike.org/osm/">here</a>
     * using custom region selection.
     **/
    private static final String OSM_DB_PATH = "../library-sp18/library-sp18/data/berkeley-2018.osm.xml";
    /**
    ...
    public static List<Map<String, Object>> getLocations(String locationName) {
        ...
        locationInfo.put("lat", current.lat);
        locationInfo.put("lon", current.lon);
